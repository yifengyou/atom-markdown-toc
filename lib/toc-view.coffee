...
class TocView
  ...
  _createToc: () ->
    @__updateTocContent()
    text = []
    text.push "<!-- TOC maxdepth:"+@options.maxdepth+" firsth1:"+@options.firsth1+" numbering:"+@options.numbering+" flatten:"+@options.flatten+" bullets:"+@options.bullets+" updateOnSave:"+@options.updateOnSave+" -->\n"
